content = open('web/src/components/DashboardSidebar.jsx').read()
...
open('web/src/components/DashboardSidebar.jsx', 'w').write(content)
print(f"Replaced {content.count('tier?.slug')} times in DashboardSidebar")
