  ...
  return (
    <>
      ...
      <div className="modal-overlay animate-fade-in" style={{ position: 'fixed', inset: 0, background: 'rgba(6, 9, 14, 0.65)', backdropFilter: 'blur(12px)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 999, padding: '24px' }}>
        <div className="modal-box" style={{ background: 'var(--bg)', borderRadius: '28px', width: '100%', maxWidth: '640px', boxShadow: '0 32px 80px rgba(0,0,0,0.35), 0 0 0 1px var(--primary-100) inset', overflow: 'hidden', display: 'flex', flexDirection: 'column', maxHeight: '85vh', animation: 'slideUpFade 0.4s cubic-bezier(0.16, 1, 0.3, 1)' }}>
          ...
          <div className="modal-search" style={{ padding: '20px 32px', background: 'var(--bg-section)', borderBottom: '1px solid var(--border)' }}>
            <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
              ...
              <input 
                ...
                onFocus={e => { e.target.style.borderColor = 'var(--primary)'; e.target.style.boxShadow = '0 8px 24px var(--primary-50)'; }}
                ...
                return (
                  <div 
                    ...
                    style={{ 
                      ...
                      boxShadow: isSelected ? '0 8px 24px var(--primary-50)' : '0 2px 8px rgba(0,0,0,0.02)'
                    }}
                  >
        ...
        <div className="modal-footer" style={{ padding: '24px 32px', borderTop: '1px solid var(--border)', background: 'var(--bg)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <button 
            ...
            style={{ 
              ...
              display: 'flex', alignItems: 'center', gap: '10px', boxShadow: '0 8px 24px var(--primary-50)', opacity: selectedSymbols.length === 0 || isAdding ? 0.7 : 1, transition: 'all 0.2s'
            }}
          >
