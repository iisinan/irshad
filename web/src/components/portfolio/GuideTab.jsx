...
const Step = ({ number, title, description }) => (
  <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
    <div style={{
      ...
      display: 'flex', alignItems: 'center', justifyContent: 'center',
      fontSize: '0.82rem', fontWeight: 900, boxShadow: '0 4px 12px rgba(209, 165, 98, 0.25)',
    }}>
      {number}
    </div>
    <div style={{ flex: 1 }}>
    ...
    <div>
      ...
      {activeSection === 'getting-started' && (
        <div className="animate-slide-up stagger-1">
          ...
          {/* What is Irshad */}
          <div style={{ background: 'linear-gradient(135deg, rgba(209, 165, 98, 0.08) 0%, rgba(198,146,32,0.03) 100%)', border: '1px solid var(--primary-100)', borderRadius: '20px', padding: '24px', marginBottom: '24px' }}>
      ...
      {activeSection === 'tutorials' && (
        <div className="animate-slide-up stagger-1">
          ...
          <div style={{ background: 'linear-gradient(135deg, rgba(209, 165, 98, 0.06) 0%, transparent 100%)', border: '1px solid var(--primary-100)', borderRadius: '14px', padding: '16px 20px', marginBottom: '20px', display: 'flex', gap: '12px', alignItems: 'center' }}>
