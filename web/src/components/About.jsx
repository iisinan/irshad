    ...
    <div style={{ maxWidth: '940px', margin: '0 auto' }}>
      ...
      <div className="about-vision-grid" style={{ marginBottom: '48px' }}>
        ...
        <div style={{
          ...
          boxShadow: '0 16px 40px rgba(0,0,0,0.3), inset 0 1px 0 rgba(209, 165, 98, 0.2)',
          border: '1px solid rgba(209, 165, 98, 0.15)'
        }}>
          <div style={{ position: 'absolute', bottom: '-50px', right: '-50px', width: '220px', height: '220px', background: 'radial-gradient(circle, rgba(209, 165, 98, 0.15) 0%, transparent 70%)', borderRadius: '50%', pointerEvents: 'none' }} />
