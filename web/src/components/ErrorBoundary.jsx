    ...
    if (this.state.hasError) {
      ...
      return (
        <div style={{
          ...
          <div style={{
            backgroundColor: 'var(--bg-section, var(--non-compliant-bg))',
            padding: '32px',
            borderRadius: '24px',
            maxWidth: '480px',
            width: '100%',
            ...
            {this.state.errorMessage && !isChunkError && (
              <p style={{ fontFamily: 'monospace', fontSize: '0.72rem', background: 'var(--non-compliant-bg)', color: '#7F1D1D', padding: '8px 12px', borderRadius: '6px', marginBottom: '16px', wordBreak: 'break-word', textAlign: 'left' }}>
