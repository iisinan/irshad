    ...
    <>
      <div className="animate-fade-in page-wrapper" style={{ paddingBottom: '0px' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto', marginBottom: '80px' }}>
          ...
          <div className="animate-fade-in stagger-1" style={{ background: 'white', borderRadius: '24px', padding: '0', boxShadow: '0 24px 64px rgba(0,0,0,0.06)', border: '1px solid var(--border)', overflow: 'hidden' }}>
            ...
            <div style={{ background: 'linear-gradient(135deg, #0D1B2A 0%, #0F5257 65%, #0B6B71 100%)', padding: '32px', position: 'relative', overflow: 'hidden' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '20px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                  ...
                  <div>
                    <h2 style={{ fontSize: '1.6rem', fontWeight: 900, color: 'white', letterSpacing: '-0.5px' }}>Resource Library</h2>
