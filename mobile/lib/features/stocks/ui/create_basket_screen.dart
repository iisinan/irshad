...
class _CreateBasketScreenState extends State<CreateBasketScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Create Basket', style: TextStyle(fontWeight: FontWeight.w900, color: context.textDark, letterSpacing: -0.5)),
        backgroundColor: context.bg,
        elevation: 0,
        leading: IconButton(
      ...
      child: AnimatedContainer(
        ...
        child: ElevatedButton(
          ...
          child: _isSaving 
              ...
              : Text('Create Basket', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, letterSpacing: 0.5)),
        ),
      ),
    );
  }
