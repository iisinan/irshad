...
$company = App\Models\Company::where('symbol', 'BRICLINKS')->first();
if ($company) {
    ...
    if ($screening) {
        ...
        $screening->save();
        echo "Updated BRICLINKS correctly!\n";
    } else {
        echo "BRICLINKS screening not found.\n";
    }
} else {
    echo "BRICLINKS company not found.\n";
}
