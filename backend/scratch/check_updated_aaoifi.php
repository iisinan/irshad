...
$tickers = ['DANGCEM', 'PZ', 'AIRTELAFRI'];

$companies = \DB::table('companies')
    ->join('aaoifi_screenings', 'companies.id', '=', 'aaoifi_screenings.company_id')
    ->whereIn('companies.symbol', $tickers)
    ->select('companies.symbol', 'aaoifi_screenings.financial_data_used', 'aaoifi_screenings.final_status', 'aaoifi_screenings.updated_at')
    ->get();

$md = "| Ticker | Updated At | Final Verdict | Latest PDF URL |\n";
$md .= "|--------|------------|---------------|----------------|\n";
