...
foreach ($updates as $symbol => $reason) {
    ...
    if ($company) {
        ...
        // Update company current status if it's not doubtful
...
echo "Successfully updated $count doubtful stocks.\n";
