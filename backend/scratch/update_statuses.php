...
$updates = [
    ...
    'S C O A' => ['status' => 'non_halal', 'reason' => 'Scholar Override: Fails AAOIFI financial limits (Debt 57.78%, Impermissible Income 5.48%).'],
    'HONEYWELL' => ['status' => 'non_halal', 'reason' => 'Scholar Override: Fails AAOIFI financial limits (Debt 30.07% > 30%).'],
