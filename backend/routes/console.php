...
Schedule::command('app:sync-market-data')->timezone('Africa/Lagos')->dailyAt('15:30')->withoutOverlapping()->emailOutputTo('iirshad2026@gmail.com');
Schedule::command('app:sync-market-data')->twiceDaily(10, 22)->withoutOverlapping()->emailOutputTo('iirshad2026@gmail.com');


Schedule::command('news:scrape-stocks')->dailyAt('18:00')->withoutOverlapping()->emailOutputTo('iirshad2026@gmail.com');
Schedule::command('app:snapshot-portfolios')->dailyAt('17:00')->withoutOverlapping()->emailOutputTo('iirshad2026@gmail.com');
...
Schedule::command('irshad:detect-compliance-changes')->dailyAt('18:30')->withoutOverlapping()->emailOutputTo('iirshad2026@gmail.com');
...
Schedule::command('irshad:notify-grace-period-end')->dailyAt('09:00')->withoutOverlapping()->emailOutputTo('iirshad2026@gmail.com');

// Send weekly updates digest
Schedule::command('irshad:send-updates-digest')->weeklyOn(5, '15:00')->withoutOverlapping()->emailOutputTo('iirshad2026@gmail.com');
...
Schedule::command('app:send-zakat-reminders')->dailyAt('08:00')->withoutOverlapping()->emailOutputTo('iirshad2026@gmail.com');

// Prune old NGXPulse audit logs daily
Schedule::command('irshad:prune-audits')->daily()->withoutOverlapping()->emailOutputTo('iirshad2026@gmail.com');
