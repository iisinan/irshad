...
class FinancialScreening(Base):
    ...
    raw_source_values = Column(JSONB, nullable=False, default=dict)
    ...
    chosen_values = Column(JSONB, nullable=False, default=dict)
    
    confidence_score = Column(Float, nullable=False, default=0.0)
    
    # E.g., {"pdf_url": "...", "ngx_url": "..."}
    source_urls = Column(JSONB, nullable=False, default=dict)
    
    # Deterministic output of the AAOIFI calculation engine
    calculation_results = Column(JSONB, nullable=False, default=dict)
