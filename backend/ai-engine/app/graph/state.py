...
class GraphState(TypedDict):
    ...
    # 3. Collect Business Intelligence (Perplexity web search)
    business_intelligence: Dict[str, Any]
    business_news: List[Dict[str, Any]]
    perplexity_financials: Dict[str, Any]   # Financial fallback from Perplexity
    ...
    # 14. Currency Conversion (Handled in Normalizer)
