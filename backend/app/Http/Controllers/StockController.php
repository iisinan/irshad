    ...
    public function aaoifiScreening(string $symbol): JsonResponse
    {
        ...
        if ($aaoifiScreening) {
            ...
            $mapped = [
                ...
                'published_date'              => $aaoifiScreening->published_date ?? $companyFin?->published_date,
                'reporting_period'            => $aaoifiScreening->reporting_period ?? $companyFin?->reporting_period,
                'reporting_year'              => $aaoifiScreening->reporting_year,
                'source_url'                  => $companyFin?->source_url,
