...
$company = App\Models\Company::where('symbol', 'DANGSUGAR')->first();
if ($company) {
    ...
    if ($screening) {
        ...
        $screening->save();
        echo "Updated DANGSUGAR correctly!\n";
    } else {
        echo "DANGSUGAR screening not found.\n";
    }
} else {
    echo "DANGSUGAR company not found.\n";
}
